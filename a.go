...
//func main() {
//	var a = ResultFun1[*os.File](os.OpenFile("./a.go", os.O_CREATE|os.O_WRONLY|os.O_APPEND, os.ModePerm))
//
//	if a.IsErr() {
//		fmt.Printf("%v", a.UnwrapErr())
//	}
//
//	b := ResultFunc2[int, int](melon())
//
//	if !b.IsErr() {
//		fmt.Printf("%v", b.Unwrap())
//	}
//
//	// var bc = ResultFun2[int, int](meme())
//
//	// fmt.Printf("%+v", bc.Unwrap().f)
//
//	if a.IsOk() {
//		var result = a.Unwrap()
//
...
//		// result.
//
//		// _, b := result.WriteString("This is it")
//		// if b != nil {
//		// 	panic(b)
//		// }
//
